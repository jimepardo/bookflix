...
<div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo" type="button" class="btn btn-danger" data-toggle="modal">Cargar editorial</button>    
            </div>    
        </div>    
    </div>    
    <br>  
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formEditorial">    
            ...
            <div class="modal-footer">
                <button type="button" id="btnCancelar" onclick="window.location='editorial.php';return false;" class="btn btn-light" data-dismiss="modal">Cancelar</button>
