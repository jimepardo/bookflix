$(document).ready(function(){
    ...
    tablaNov = $('#tablaNov').DataTable({ 
        "ajax":{            
            "url": "vistas/crudnovedadesgenerales.php", 
        ...
        "columns":[
            ...
            {"defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-secondary btn-sm btnEditar'><i class='material-icons'>Modificar</i></button></div></div>" //<button class='btn btn-danger btn-sm btnBorrar'><i class='material-icons'>Borrar</i></button>
        }],
    ...
    $("#formNov").submit(function(e){
       ...
       // var fechaFormulario = new Date(desde);
        ...
        $.ajax({
            ...
            type: "POST",
            dataType: "json",
            data: {borrado:borrado, descripcion:descripcion, desde:desde, id:id, opcion:opcion},
    ...
    $("#btnNuevo").click(function(){
        ...
        $(".modal-title").text("Nueva novedad general");            
    ...
    $(document).on("click", ".btnEditar", function(){
        ...
        $(".modal-header").css("color", "#F5F5F1");
        $(".modal-title").text("Modificar novedad general");            
        $('#modalCRUD').modal('show');  
