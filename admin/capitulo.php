                ...
                <form id="formLibros" enctype="multipart/form-data">    
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label for="vistaprevia" class="col-form-label">Vista Previa PDF:</label>
                                    <input type="file" class="form-control" name="vistaprevia" id="vistaprevia">
                                </div>
                            </div>
                        </div>
