...
<div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo" type="button" class="btn btn-danger" data-toggle="modal">Cargar autor</button>    
            </div>    
        </div>    
    </div>    
    <br>  
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formAutor">    
            ...
            <div class="modal-footer">
                <button type="button" id="btnCancelar" onclick="window.location='autor.php';return false;" class="btn btn-light" data-dismiss="modal">Cancelar</button>
...
<script type="text/javascript" src="autor.js"></script> 