        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-4">
                <div class="card text-center">                
                    ...
                    <a href="#" id="bas" name="bas" class="card-footer btn bg-danger text-white">Contratar</a> 
                </div>                
            </div> <!-- precio 1-->
            <div class="col-md-4"> <!-- precio 2-->
                <div class="card text-center">
                    ...
                    <a href="#" id="prem" name="prem" class="card-footer btn bg-danger text-white" style="color:#000;">Contratar</a>
                </div>                
            </div> <!-- precio 2-->
        </div>
    </div>
