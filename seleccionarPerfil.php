        ...
        <div class="col-sm-3 " >
            <div class="modal-content" style="height: 24em;width: 15em;">
                ...
                <div class="form-group" id="user-group">
                    ...
                    <a href="seleccionar.php?PERFIL=<?= $name ?>&PERFILIMG=<?= $img?>&GENEROFAV=<?= $genfav ?>&AUTORFAV=<?= $autorfav ?>" class="btn btn-danger"> Seleccionar<svg class="bi bi-box-arrow-in-right" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
