...
<head>
    <meta charset="utf-8">
    <title>Bookflix - Mi Historial</title>
    ...
    if(isset($_SESSION['PERMISO'])){
        if (($_SESSION['PERMISO'] == 1) || ($_SESSION['PERMISO'] == 2) || ($_SESSION['PERMISO'] == 3)){
            ...
            <?php        
                ...
                WHERE editorial.borradoParanoagregar='0' AND autor.borradoParanoagregar='0' AND libro.borradoLogico = 0 AND libro.idLibro=historial.idLibro AND historial.borradoLogico=0 AND historial.idPerfil = $idPerfil "; 
                ...
                <h2 class="titulos">Mi historial </h2>
                <div style="color:white; text-size:20px; margin-left: 20px;">Aún no ha terminado de leer ningún libro!</div>
                <?php
