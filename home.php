...
<head>
    ...
    switch ($_SESSION['PERMISO']) {
		case 1:?>
            <!--Esta es la barra de navegacion del usuario registrado-->
		...
		case 3:?>
                ...
                <img src="img/logo1.png" width=110px alt="Imagen PNG alternativa">
                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <a href="admin/index.php"><button type="button" class="btn btn-danger " style="margin-right: 25px; text-align: center;">Volver al dash</button></a>        
                        </ul>        
                    </div>
                </nav>
            </div>
            ...
            break;
		case false:?>
            <!--Esta es la barra de navegacion para los usuarios no registrados hay que cambiarla con los roles pisa a la otra -->
